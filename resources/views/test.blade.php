...
<head>
    ...
    <meta property="og:image" content="https://tu-farmacia.com/imagen.jpg">
    <meta property="og:url" content="https://tu-farmacia.com">
    ...
    <meta name="twitter:image" content="https://tu-farmacia.com/imagen-twitter.jpg">
    ...
    <link rel="stylesheet" href="{{ asset('assets/OwlCarousel/src/owl.carousel.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/OwlCarousel/src/owl.theme.default.min.css') }}" />
    ...
    <header class="navbar navbar-expand navbar-light bg-light shadow py-3">
        <nav class="container">
            ...
            <div class="col-3 d-flex align-items-center justify-content-center">
                <a class="navbar-brand" href="https://www.farmacia701.com/Inicio">
                    <img src="https://www.farmacia701.com/img/logo.png" alt="" width="50" height="50" />
                </a>
            </div>
        ...
        <div class="navbar">
            <div class="container d-flex justify-content-center align-self-center">
                ...
                <div class="col-12 col-md-3">
                    <span class="h6 text-uppercase d-flex justify-content-center align-items-center"> <img src="https://www.farmacia701.com/img/logo.png" alt=""> <i
                            class="fa-solid fa-plus"></i> <img src="https://www.farmacia701.com/img/zoom.png" alt=""></span>
                </div>
    ...
    <footer class="bg-primary text-light pt-5 pb-3">
        <div class="container">
            ...
            <div class="text-center pt-3">
                <p class="mb-0">&copy; 2024 Farmacia 701. Todos los derechos reservados.</p>
            </div>
        </div>
    </footer>
