    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.faults.*') ? 'active' : '' }}" href="{{ route('admin.faults.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-exclamation-triangle text-dark text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Módulo de Fallas</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.sales.*') ? 'active' : '' }}" href="{{ route('admin.sales.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-shopping-cart text-dark text-sm opacity-10"></i>
                    </div>
