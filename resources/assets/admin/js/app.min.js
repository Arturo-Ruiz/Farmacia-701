(() => {
    ...
    document.getElementById("navbarBlur") &&
        "true" ==
            document.getElementById("navbarBlur").getAttribute("data-scroll") &&
    ...
    if (e.getAttribute("checked")) {
        ...
        for (L = 0; L < a.length; L++)
            a[L].classList.contains("text-white") &&
                (a[L].classList.remove("text-white"),
                a[L].classList.add("text-dark"));
        for (L = 0; L < r.length; L++)
            !r[L].classList.contains("text-white") ||
                r[L].closest(".sidenav") ||
                r[L].closest(".card.bg-gradient-dark") ||
                (r[L].classList.remove("text-white"),
                r[L].classList.add("text-dark"));
        for (L = 0; L < o.length; L++)
            o[L].classList.contains("text-white") &&
                (o[L].classList.remove("text-white"),
                o[L].classList.add("text-dark"));
        for (L = 0; L < d.length; L++)
            d[L].classList.contains("text-white") &&
                !d[L].closest(".sidenav") &&
                (d[L].classList.remove("text-white"),
                d[L].classList.add("text-dark"));
        ...
        for (L = 0; L < m.length; L++)
            m[L].closest(".card.bg-gradient-dark") ||
                (m[L].classList.remove("text-white"),
                m[L].classList.add("text-dark"));
        ...
        for (var L = 0; L < a.length; L++)
            a[L].classList.contains("text-dark") &&
                (a[L].classList.remove("text-dark"),
                a[L].classList.add("text-white"));
        for (var L = 0; L < i.length; L++)
            i[L].classList.contains("text-dark") &&
                (i[L].classList.remove("text-dark"),
                i[L].classList.add("text-white"));
        for (var L = 0; L < l.length; L++)
            l[L].classList.contains("text-dark") &&
                (l[L].classList.remove("text-dark"),
                l[L].classList.add("text-white"));
        for (var L = 0; L < c.length; L++)
            c[L].classList.contains("text-dark") &&
                (c[L].classList.remove("text-dark"),
                c[L].classList.add("text-white"));
        ...
        for (var L = 0; L < g.length; L++)
            g[L].classList.remove("text-dark"),
                g[L].classList.add("text-white");
